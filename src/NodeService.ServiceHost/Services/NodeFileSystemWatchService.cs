...
{
    public class NodeFileSystemWatchService : BackgroundService
    {
        ...
        private readonly ILogger<NodeFileSystemWatchService> _logger;
        private readonly IAsyncQueue<BatchQueueOperation<FileSystemWatchConfigModel, bool>> _fileSystemWatchConfigQueue;

        readonly ConcurrentDictionary<string, FileSystemWatcherInfo> _watchers;
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                var op = await _fileSystemWatchConfigQueue.DeuqueAsync(cancellationToken);
                try
                {
                    ...
                    switch (op.Kind)
                    {
                        ...
                        case BatchQueueOperationKind.Delete:
                            this.DeleteFileSystemWatcherInfo(op.Argument);
                            break;
