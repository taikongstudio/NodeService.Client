...
namespace JobsWorkerWebService.Services.VirtualSystem
{
    ...
    CancellationToken cancellationToken = default);
        ...
        ValueTask<bool> UploadStream(string path, Stream stream, CancellationToken cancellationToken = default);
    ...
    public abstract class VirtualFileSystemBase : IVirtualFileSystem
    {
        ...
        public abstract ValueTask<bool> UploadStream(string path, Stream stream, CancellationToken cancellationToken = default);
