...
#endif
            {
                _objQueue.Enqueue(new PendingFinalization {
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public class FinalizationException : Exception
    {
        ...
        /// </summary>
        public PyObject GetObject() => new(new BorrowedReference(Handle));
        /// <summary>
        ...
        {
            IntPtr dangerousNoIncRefCopy = Handle;
