...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public PyObject MoveToPyObject()
        {
            ...
            return new PyObject(StealNullable());
        }
        ...
        {
            var result = DangerousFromPointer(DangerousGetAddress());
            pointer = default;
            return result;
        }
        ...
        /// the pointer. Sets the original reference to <c>null</c>, as it no longer owns it.
        /// </summary>
        public PyObject? MoveToPyObjectOrNull() => IsNull() ? null : MoveToPyObject();
        ...
        [DebuggerHidden]
        public StolenReference StealNullable() => StolenReference.TakeNullable(ref pointer);
        ...
        {
            if (IsNull()) throw PythonException.ThrowLastAsClrException();
