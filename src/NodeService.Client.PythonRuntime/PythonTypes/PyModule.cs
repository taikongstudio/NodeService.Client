...
namespace Python.Runtime
{
    ...
    public class PyModule : PyObject
    {
        ...
        {
            NewReference op = Runtime.PyImport_ReloadModule(Reference);
        ...
        public PyModule SetBuiltins(PyDict builtins)
        {
            ...
            BorrowedReference globals = Runtime.PyModule_GetDict(Reference);
        ...
        {
            result = CheckNone(Get(binder.Name));
            return true;
        }
