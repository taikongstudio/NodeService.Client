...
namespace JobsWorker.Shared.Models
{
    ...
    public class NodePropertyModel
    {
        ...
        public const string FactoryName_key = "FactoryName";
        ...
        public static NodePropertyModel FromNodePropertyItems(IEnumerable<NodePropertyEntry>? items)
        {
            var properties = new NodePropertyModel();
                ...
                foreach (var nodePropertyItem in items)
                {
                    switch (nodePropertyItem.Name)
                    {
                        ...
                        case CollectTimeSpan_Key:
                            ...
                            break;
                        case FactoryName_key:
                            properties.FactoryName = nodePropertyItem.Value;
                            break;
                        default:
                            break;
                    }
