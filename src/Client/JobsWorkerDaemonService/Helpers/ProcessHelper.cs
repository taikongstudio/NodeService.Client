...
namespace JobsWorkerDaemonService.Helpers
{
    public static class ProcessHelper
    {
        ...
        public static bool StartProcessAsCurrentUser(string appPath, ILogger logger, out uint processId, string cmdLine = null, string workDir = null, bool visible = true)
        {
            processId = 0;
