...
namespace JobsWorkerNodeService.Interop.Kafka
{
    public class ProducerUtil
    {
        ...
        public bool SendMsg(string msg)
        {
            ...
            {
                if (!r.Error.IsError)
                    this._logger.LogInformation($"Delivered message to {r.TopicPartitionOffset}");
                else
                    this._logger.LogError($"Delivery Error: {r.Error.Reason}");
            };
            try
            {
