    ...
    internal class UploadAppLogsToFtpServerJob : JobBase
    {
        ...
        private async Task UploadLogsToFtpServer()
        {
            try
            {
                ...
                var server = Arguments[nameof(FtpServerConfig.server)];
                var username = Arguments[nameof(FtpServerConfig.username)];
                var password = Arguments[nameof(FtpServerConfig.password)];
                var localLogDirectory = Arguments[nameof(FtpServerConfig.localLogDirectory)];
                var remoteLogDirectoryFormat = Arguments[nameof(FtpServerConfig.remoteLogDirectoryFormat)];
