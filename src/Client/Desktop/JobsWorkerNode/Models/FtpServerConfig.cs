...
namespace JobsWorkerNode.Models
{
    public class FtpServerConfig
    {
        ...
        public static LoadConfigResult TryLoadServerConfig(string configPath,
            ref int hashCode,
            ILogger logger,
            out FtpServerConfig ftpServerConfig)
        {
            ...
            try
            {
                ...
                logger?.LogInformation("Load config success:");
        ...
        public static bool TryLoadServerConfig(string configPath,
            ILogger logger,
            out FtpServerConfig ftpServerConfig)
        {
            ftpServerConfig = null;
